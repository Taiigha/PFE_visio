...
var app = {
    ...
    onDeviceReady: function() {
        ...
        console.log("Ready : permissions ?");
        const permissions = cordova.plugins.permissions;
        console.log("permissions created var");
        permissions.hasPermission(permissions.CAMERA, function(status) {
          if(! status.hasPermission)
            permissions.requestPermission(permissions.CAMERA, error("SUCCES", "camera granted"), error("GAMEOVER", "camera not granted"));
          });
    },
...
document.getElementById("audioCallButton").onclick = function() {call(false);};
document.getElementById("videoCallbutton").onclick = function() {call(true);};
document.getElementById("hangUpButton").onclick = function() {wantToHangUp("Votre correspondant a raccroché.");};
document.getElementById("sendText").onclick = function() {sendMessage();};
document.getElementById("connectToSignalingServerButton").onclick = function() {connectToSignalingServer();};
